...
export const DYNAMODB_ACTION_INVENTORY: readonly DynamoActionInventoryEntry[] = [
  ...
  { action: "DescribeExport", phase: "DDB-10", status: "implemented" },
  ...
  { action: "DescribeImport", phase: "DDB-10", status: "implemented" },
