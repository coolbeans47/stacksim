...
export function emptyState(accountId = DEFAULT_ACCOUNT_ID, region = "eu-west-1"): SimState {
  return {
    ...
    accounts: { [accountId]: { iam: createIamState(Date.now(), accountId), cloudwatchDashboards: {}, regions: { [region]: emptyRegion() } } },
  };
}
