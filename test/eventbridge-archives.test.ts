...
test("EVB-04 SDK lifecycle proves independent capture, selected replay identity, and no re-archiving", async () => {
  ...
  await h.client.send(new PutEventsCommand({ Entries: [{ EventBusName: "learning", Source: "learning.orders", DetailType: "Order", Detail: "{\"id\":1}", Time: eventTime }, { EventBusName: "learning", Source: "learning.inventory", DetailType: "Inventory", Detail: "{}", Time: eventTime }] }));
