# Pinned Amplify Gen 2 auth-data-owner fixture
...
```sh
npm ci --prefix test/fixtures/amplify-gen2-auth-data-owner --no-audit --no-fund
node scripts/capture-amplify-gen2-evidence.mjs --fixture test/fixtures/amplify-gen2-auth-data-owner --synthesis-only --bootstrap --identifier amx13 --output .tmp/auth-data-owner-synthesis.json
node scripts/generate-amplify-auth-evidence.mjs amplify-gen2-auth-data-owner .tmp/auth-data-owner-synthesis.json --verify-repeat
```
