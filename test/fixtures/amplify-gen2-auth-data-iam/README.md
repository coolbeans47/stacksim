# Pinned Amplify Gen 2 auth-data-iam fixture
...
```sh
npm ci --prefix test/fixtures/amplify-gen2-auth-data-iam --no-audit --no-fund
node scripts/capture-amplify-gen2-evidence.mjs --fixture test/fixtures/amplify-gen2-auth-data-iam --synthesis-only --bootstrap --identifier amx13 --output .tmp/auth-data-iam-synthesis.json
node scripts/generate-amplify-auth-evidence.mjs amplify-gen2-auth-data-iam .tmp/auth-data-iam-synthesis.json --verify-repeat
```
