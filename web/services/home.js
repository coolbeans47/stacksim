...
async function home() {
  ...
  const services = [
    ...
    { key: "cloudfront", cls: "cloudfront", name: "CloudFront", label: "Distributions", count: summary.cloudfrontDistributionCount ?? summary.counts.distributions ?? 0, text: "Serve private S3 websites through local edge behavior.", href: "#/cloudfront/distributions" },
    ...
    { key: "cognito-identity", cls: "cognito", name: "Cognito Identity Pools", label: "Identity pools", count: summary.counts.cognitoIdentityPools ?? 0, text: "Exchange User Pool ID tokens for temporary AWS credentials.", href: "#/cognito-identity/identity-pools" },
